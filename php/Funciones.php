<?php
	...
	function hola ()
	{
		...
		El Rey te proporcionará una pista al inicio de la adivinanza, y conforme avances en el proceso...y al Rey comience a darle hambre, te proporcionará pistas para terminar más rápido con ésto.</p>

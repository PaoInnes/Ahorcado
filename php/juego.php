...
<html>
	<head>
		...
		<meta charset="UTF-8" />
		<link rel="stylesheet" href="juego_diseno.css"/>
			...
			<?php
				...
				else
				{
					if ($_SESSION['error']>10)
						...
						echo '<p class="preguntar">Yo soy intimo amigo del rey, si gustas puedo pedirle que te de otra oportunidad.</p>';
						}
					else
						{
					...
					echo '<form action="respuesta.php" method="post">';
						echo '<p class="preguntar"><ins>¡Claro que si! </ins><input type="radio" style="width:25px;height:25px" name="respuesta" value="1" /><br /><br />';

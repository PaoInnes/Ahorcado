		...
		<div id="trans">
			<?php
				...
				echo    '<h1 id="principal">-AHORCADO-</h1>
						<p>En el reino de Cremme BruLand regía un Rey que adoraba comer, pero su gran debilidad eran los postres, lo cual hacía que todo lo relacionara a ellos, flanes, mousse y algunos pasteles. Cuando algún expedicionario regresaba exitoso de un viaje, el rey los premiaba con una gran variedad de postres.
				...
				if($exist==true)
				{
					...
					echo '<img src="..\archivos\img'.$_COOKIE['imagen'].'.jpeg" />';
